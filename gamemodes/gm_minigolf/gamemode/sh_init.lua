...
Minigolf.TEAM_NAME_LENGTH_MAX_MESSAGE = string.format("Your team name can only be %d characters long!",
	Minigolf.TEAM_NAME_LENGTH_MAX)
Minigolf.TEAM_NAME_LENGTH_MIN = 2
Minigolf.TEAM_NAME_LENGTH_MIN_MESSAGE = string.format("Your team name must be at least %d characters long!",
	Minigolf.TEAM_NAME_LENGTH_MIN)
