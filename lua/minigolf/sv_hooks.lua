...
hook.Add("Minigolf.TimeLimitReached", "Minigolf.OutOfTimeMessage", function(player, ball, start)
	Minigolf.Messages.Send(player, "Disqualified! You ran out of time on '" .. start:GetHoleName() .. "'", nil, Minigolf.TEXT_EFFECT_ATTENTION)
...
hook.Add("Minigolf.StrokeLimitReached", "Minigolf.StrokeLimitMessage", function(player, ball, start)
	Minigolf.Messages.Send(player, "Disqualified! You have ".. start:GetMaxStrokes() .." strokes on '" .. start:GetHoleName() .. "'", "¢", Minigolf.TEXT_EFFECT_ATTENTION)
