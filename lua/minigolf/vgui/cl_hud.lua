...
function PANEL:Paint(w, h)
	...
	for _, text in pairs(texts) do
		...
		draw.SimpleTextOutlined(text, font, w - Minigolf.PADDING, Minigolf.PADDING + currentY, Minigolf.COLOR_LIGHT,
			TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 1, Minigolf.COLOR_DARK)
	...
	self.activeHolePanel:SetPos(w - self.activeHolePanel:GetWide() - Minigolf.PADDING,
		h - self.activeHolePanel:GetTall() - Minigolf.PADDING)
